...
{       
    ...
    public class DALSubCategoria
    {
        ...
        {
            DataTable dataTable = new DataTable();                           //instancia objetop do tipo datatable
            SqlDataAdapter dataAdapter = new SqlDataAdapter("select sc.scat_cod, sc.scat_nome, sc.cat_cod, c.cat_nome " + 
            ...
            dataAdapter.Fill(dataTable);        //ira preencher a tabela com os valores do comando executado...
